...
module.exports = function (conf, resolve) {
	return function (path/*, …data*/) {
		...
		if (typeof controller === 'function') return resolve(apply.call(controller, this, data));
		args = [];
		while (tokens.length > 1) {
			...
			if (match) {
				if (match.apply(this, args)) return resolve(apply.call(controller.controller, this, data));
				return false;
			}
		}
		return false;
