...
module.exports = function (conf/*, options*/) {
	var match = {}, direct = {}, options = Object(arguments[1]), eventProto;

	if (options.eventProto != null) eventProto = ensureObject(options.eventProto);
	...
	return defineProperty(function (path/*, …data*/) {
		...
		else if (eventProto) context = create(eventProto);
		else context = {};
