...
module.exports = function (conf) {
	...
	return defineProperty(function (path/*, …data*/) {
		var pathTokens, data = slice.call(arguments, 1), conf, controller, result;
		...
		if (conf) {
			...
			try {
				result = apply.call(controller, this, data);
			} catch (e) {
				e.conf = conf;
				throw e;
			}
			...
			try {
				result = apply.call(conf.controller, this, data);
			} catch (e) {
				e.conf = conf;
				throw e;
			}
